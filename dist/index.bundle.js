...
/* harmony import */ var _modules_localStorage_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_localStorage_js__WEBPACK_IMPORTED_MODULE_3__);
...
document.querySelector('.add-to-list').addEventListener('submit', (e) => {
  ...
  const todolists = _modules_localStorage_js__WEBPACK_IMPORTED_MODULE_3___default().getToDoLists();
  ...
  _modules_localStorage_js__WEBPACK_IMPORTED_MODULE_3___default().addToDoLists(todotask);
...
class Completelist {
  static CompleteToDoList() {
    ...
    checkbox.forEach((elemnt) => {
      elemnt.addEventListener('change', (e) => {
        _localStorage_js__WEBPACK_IMPORTED_MODULE_0___default().completetask(e.target.parentElement.parentElement.id);
      });
    });
  }
  ...
  static clearCompleted() {
    ...
    clearButton.addEventListener('click', () => {
      let todolists = _localStorage_js__WEBPACK_IMPORTED_MODULE_0___default().getToDoLists();
      todolists = todolists.filter((elemnt) => elemnt.completed !== true);
      localStorage.setItem('todolists', JSON.stringify(todolists));
      window.location.reload();
      _localStorage_js__WEBPACK_IMPORTED_MODULE_0___default().resetIndex();
    });
  }
}
...
class UI {
  ...
  static showToDoLists() {
    const todolists = _localStorage_js__WEBPACK_IMPORTED_MODULE_0___default().getToDoLists();
  ...
  static removeToDoLists() {
    ...
    remove.forEach((bin) => {
      bin.addEventListener('click', (e) => {
        ...
        _localStorage_js__WEBPACK_IMPORTED_MODULE_0___default().removeToDoLists(
  ...
  static updateDesc() {
    ...
    description.forEach((element) => {
      element.addEventListener('change', (e) => {
        _localStorage_js__WEBPACK_IMPORTED_MODULE_0___default().updateDesc(
          e.target.value,
